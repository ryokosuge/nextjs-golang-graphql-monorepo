...
export type QueryQuery = { __typename?: 'Query', todos: Array<{ __typename?: 'Todo', id: string }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Query(variables?: QueryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<QueryQuery> {
