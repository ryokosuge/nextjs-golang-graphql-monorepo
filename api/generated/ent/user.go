...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldFirebaseUUID, user.FieldName, user.FieldEmail:
	...
	for i := range columns {
		...
		case user.FieldFirebaseUUID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field firebaseUUID", values[i])
			} else if value.Valid {
				u.FirebaseUUID = value.String
			}
		case user.FieldName:
			if value, ok := values[i].(*sql.NullString); !ok {
...
func (u *User) String() string {
	...
	builder.WriteString("firebaseUUID=")
	builder.WriteString(u.FirebaseUUID)
	builder.WriteString(", ")
